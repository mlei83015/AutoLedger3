...
V7 新增內容：
- 新增左側功能選單：帳務報表、發票記帳、記帳小工具、共享帳本、分類管理、固定收支、財務模擬、功能設定。
- 統計頁改成帳務報表風格：支出/收入/結餘切換、月/近六個月/年/自訂區塊、全幣別顯示、本月支出圓形圖與無資料狀態。
- 保留 V6 的隱私權政策、新手教學、CSV 匯出、備份/還原、清除資料二次確認、分類管理、常用項目、錯誤回報、自動除錯、防重複記帳。
