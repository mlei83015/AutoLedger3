...
public class TransactionStore {
    ...
    public static synchronized boolean add(Context context, Transaction tx) {
        ...
        if (AppSettings.getBool(context, AppSettings.KEY_DEDUPE, true) && looksDuplicate(list, tx)) {
            return false;
        }
        list.add(tx);
    ...
    private static boolean looksDuplicate(List<Transaction> list, Transaction tx) {
