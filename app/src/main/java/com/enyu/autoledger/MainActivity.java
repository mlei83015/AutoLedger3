...
public class MainActivity extends Activity {
    ...
    private final int BG = 0xFFFFFCF7;
    private final int CARD = 0xFFFFFFFF;
    private final int TEXT = 0xFF23262D;
    private final int MUTED = 0xFF727985;
    ...
    private void showHome() {
        ...
        if (!isNotificationListenerEnabled()) {
            ...
            Button appNotify = pill("② 開啟本 App 通知權限", 0xFFF4F4F4, TEXT);
        ...
        int balance = TransactionStore.totalIncome(this) - TransactionStore.totalExpense(this);
    ...
    private void showManual(String direction) {
        ...
        Button expenseBtn = pill("↓  支出", !startIncome ? TEAL : 0xFFF4F4F4, !startIncome ? 0xFFFFFFFF : TEXT);
        Button incomeBtn = pill("↑  收入", startIncome ? PURPLE : 0xFFF4F4F4, startIncome ? 0xFFFFFFFF : TEXT);
        ...
        date.setBackground(round(0xFFFFFFFF, dp(12), 0xFFE8E8E8));
    ...
    private void addRecentChips(LinearLayout box, boolean income, EditText category, EditText merchant) {
        ...
        for (String r : recents) {
            Button chip = smallChip(r, 0xFFF7F7F8, TEXT);
            chip.setOnClickListener(v -> {
                merchant.setText(r);
    ...
    private void showSettings() {
        ...
        for (String th : themeNames) {
            Button b = smallChip((AppSettings.getTheme(this).equals(th) ? "✓ " : "") + th, AppSettings.getTheme(this).equals(th) ? 0xFFFFF0EA : 0xFFF7F7F8, ORANGE);
    ...
    private LinearLayout card() {
        ...
        l.setBackground(round(CARD, dp(16), 0xFFEFEFF2));
        return l;
    }
    ...
    private EditText edit(String hint, boolean prefixMoney) {
        ...
        e.setBackground(round(0xFFFFFFFF, dp(12), 0xFFE8E8E8));
        return e;
    }
